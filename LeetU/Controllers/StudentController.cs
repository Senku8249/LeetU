...
public class StudentController : ControllerBase
{
    ...
    [HttpGet("ids")]
    public IActionResult GetStudentIds()
    {
        var ids = _studentService.GetAllStudentIds();
        return Ok(ids);
    }

    // GET api/courses/{courseId}/students/ids
    [HttpGet("{courseId:long}/students/ids")]
    public IActionResult GetStudentIdsByCourseId(long courseId)
    {
        var ids = _studentService.GetStudentIdsByCourseId(courseId);
        return Ok(ids);
    }
}